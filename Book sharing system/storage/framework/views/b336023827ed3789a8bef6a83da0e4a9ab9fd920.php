   ...
   <nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container">
      <a class="navbar-brand mr-5" href="index.html">
        <img src="<?php echo e(asset('images/logo.jpg')); ?>" class="logo-image">
      </a>
  ...
  <div id="carouselExampleIndicators" class="carousel slide main-slider" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="<?php echo e(asset('images/sliders/slider1.png')); ?>" class="d-block w-100">
      ...
      <div class="carousel-item">
        <img src="<?php echo e(asset('images/sliders/slider2.png')); ?>" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h3>Welcome to your Book Sharing Platform</h3>
          <p>
      ...
      <div class="carousel-item">
        <img src="<?php echo e(asset('images/sliders/slider3.jpg')); ?>" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h3>Welcome to your Book Sharing Platform</h3>
          <p>
            <a href="" class="btn btn-primary slider-link">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="single-book">
                <img src="<?php echo e(asset('images/books/book.jpg')); ?>" alt="">
            ...
            <div class="col-md-4">
              <div class="single-book">
                <img src="<?php echo e(asset('images/books/book2.jpg')); ?>" alt="">
                <div class="book-short-info">
                  <h5>C Programming</h5>
                  <p>
                    <a href="" class=""><i class="fa fa-upload"></i> Polash Rana</a>
            ...
            <div class="col-md-4">
              <div class="single-book">
                <img src="<?php echo e(asset('images/books/book1.jpg')); ?>" alt="">
                <div class="book-short-info">
                  <h5>C++ Programming</h5>
                  <p>
                    <a href="" class=""><i class="fa fa-upload"></i> Polash Rana</a>
            ...
            <div class="col-md-4">
              <div class="single-book">
                <img src="<?php echo e(asset('images/books/book3.jpg')); ?>" alt="">
                <div class="book-short-info">
                  <h5>Java Programming</h5>
                  <p>
                    <a href="" class=""><i class="fa fa-upload"></i> Polash Rana</a>
            ...
            <div class="col-md-4">
              <div class="single-book">
                <img src="<?php echo e(asset('images/books/book4.jpg')); ?>" alt="">
                <div class="book-short-info">
                  <h5>Java Programming</h5>
                  <p>
                    <a href="" class=""><i class="fa fa-upload"></i> Polash Rana</a>
...
<?php /**PATH C:\xampp\htdocs\book\resources\views/welcome.blade.php ENDPATH**/ ?>